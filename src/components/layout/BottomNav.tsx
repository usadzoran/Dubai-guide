...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-50 bg-slate-950/95 backdrop-blur-lg border-t border-slate-800/90 pb-safe">
        ...
        {navItems.map(item => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-[11px] mt-0.5 font-medium tracking-tight ${isActive ? 'font-bold' : ''}`}>
                {item.label}
              </span>
            </button>
          );
